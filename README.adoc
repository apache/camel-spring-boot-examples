...
| link:genai-observability/README.adoc[Genai Observability] (genai-observability) | AI | Spring Boot example for Camel GenAI observability with LangChain4j and Ollama
...
| link:kafka-offsetrepository/README.adoc[Kafka Offsetrepository] (kafka-offsetrepository) | Messaging | An example for Kafka using Offset Repository
