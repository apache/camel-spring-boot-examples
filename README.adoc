...
| link:https://github.com/wangyan100/sapjcoserver[Sapjcoserver] (sapjcoserver) | SAP | An example showing how to work with Camel,SAP JCOServer and Spring Boot

| link:https://github.com/wangyan100/sapjcoclient[Sapjcoclient] (sapjcoclient) | SAP | An example showing how to work with Camel,SAP JCOClient and Spring Boot
