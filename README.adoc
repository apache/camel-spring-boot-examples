...
| link:sapjcoserver/readme.md[SAP JCOServer] (sapjcoserver) | SAP | An example showing how to receive SAP ABAP CallBack's result then direct it to Camel File in Spring Boot application

| link:sapjcoclient/readme.md[SAP JCOClient] (sapjcoclient) | SAP | An example showing how to call SAP ABAP Function via Camel Processor then store the result to Camel File in Spring Boot application
|===
// examples: END
