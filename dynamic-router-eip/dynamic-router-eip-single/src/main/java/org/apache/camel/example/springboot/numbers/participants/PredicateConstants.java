...
public abstract class PredicateConstants {
    ...
    public static final BiFunction<Exchange, Integer, Boolean> noRemainder = (e, m) ->
            e.getMessage().getHeader("number", Integer.class) % m == 0;
     ...
     */
    public static final Predicate PREDICATE_ODD = e -> !noRemainder.apply(e, 2);
    ...
    public static final Predicate PREDICATE_PRIMES = e -> {
        int n = e.getMessage().getHeader("number", Integer.class);
