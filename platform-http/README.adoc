...
o.a.c.impl.engine.AbstractCamelContext   : Apache Camel 4.19.0 (MyCamel) is starting
...
o.a.c.impl.engine.AbstractCamelContext   : Apache Camel 4.19.0 (MyCamel) started in 8ms (build:0ms init:0ms start:8ms boot:428ms)
