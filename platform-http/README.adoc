...
o.a.c.impl.engine.AbstractCamelContext   : Apache Camel 4.17.0-SNAPSHOT (MyCamel) is starting
...
o.a.c.impl.engine.AbstractCamelContext   : Apache Camel 4.17.0-SNAPSHOT (MyCamel) started in 8ms (build:0ms init:0ms start:8ms boot:428ms)
