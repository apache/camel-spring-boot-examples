...
//CHECKSTYLE:OFF
/**
 * A Spring Boot application that starts the Camel Observation application.
 * <p/>
 * Notice we use the `@CamelObservation` annotation to enable Camel with Micrometer Observation.
 */
